...
def prepare_llm(bits=16, is_lora=True, double_quant=True, quant_type='nf4', ckpt="/mnt/ssd/lbk-cvpr/checkpoints/llava-v1.5-7b"):
    ...
    model = LlavaLlamaForCausalLM.from_pretrained(ckpt, **bnb_model_from_pretrained_args)
