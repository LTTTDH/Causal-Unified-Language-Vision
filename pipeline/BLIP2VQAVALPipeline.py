        ...
        for dataset_label in dataset_names:
            ...
            with torch.no_grad():
                ...
                for idx, batch in prog_bar:
                    ...
                    # Generate
                    with torch.inference_mode():
                        generate_ids = blip2_model.generate(**{k:v.to(trainer.accel.device) for k,v in blip2_inputs.items()}, max_new_tokens=10, min_length=1, num_beams=5, length_penalty=-1, use_cache=True)
