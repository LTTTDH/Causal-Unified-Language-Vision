...
class BakLLaVAVQAPipeline:
    ...
    def evaluate_model(
        ...
        llava_model = LBK.from_pretrained(BAKLLAVA_LOCAL_PATH, load_in_8bit=True, device_map=self._opt['rank'], torch_dtype=torch.bfloat16, attn_implementation="flash_attention_2")
