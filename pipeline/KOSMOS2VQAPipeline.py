        ...
        for dataset_label in dataset_names:
            ...
            with torch.no_grad():
                ...
                for idx, batch in prog_bar:
                    ...
                    # KOSMOS2 Process
                    prompt = [f"Answer the question using a single word or phrase. Question: {b['captions'][0]} Answer:" for b in batch]
                    kosmos2_inputs = kosmos2_processor(text=prompt, images=torch.stack([b['image'] for b in batch]), return_tensors="pt")
